...
In order to build custom input elements, we need to create a `<FieldInput />` component which will consist of `size`, `size`, `startContent` and `endContent` props, and will be used as a wrapper component.
