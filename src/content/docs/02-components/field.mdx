...
In order to build input elements, we need to create a `<FieldInput />` component which will consist of `size`, `radius`, `startContent` and `endContent` props, and will be used as a wrapper component.
